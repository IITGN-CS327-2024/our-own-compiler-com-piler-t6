...
NMax = 700  # Maximum input length
RMax = 60  # Maximum number of non-terminals
...
# CFG rules
R = {
  1: [["VD_Content", "X6"], ["GivenBlock", "Y1"], ["GivenBlock", "OtherwiseBlock"], ["FuncBlock", "Block"]],
  2: [["X1", "Expression"]],
  3: [["X2", "X7"]],
  4: [['X3', 'X8']],
  5: [['X4', 'DataType']],
